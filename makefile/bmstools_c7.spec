...
%install
rm -rf %{buildroot}
install -p -D -m 755 %{SOURCE0} %{buildroot}/usr/lib/systemd/system/bmstools.service
...
%postun
if [ $1 == 0 ]; then
  rm -rf /usr/lib/systemd/system/bmstools.service
fi
...
%config(noreplace) /usr/lib/systemd/system/bmstools.service
